...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - MKR Collge of Arts And Science");
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/general.jpg"));
            ...
            JLabel l6 = new JLabel("Address: 12,North Street,Chennai");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l8 = new JLabel("Contact : mkr01@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Education - Arts And Science");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Phone-918769686543");
